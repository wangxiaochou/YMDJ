        ...
        if (android.os.Build.VERSION.SDK_INT > android.os.Build.VERSION_CODES.LOLLIPOP) {
            ...
            if (list.size() > 0) {// 有"有权查看使用权限的应用"选项
                try {
                    ...
                    android.app.AppOpsManager aom = (android.app.AppOpsManager) Utils.getContext().getSystemService(Context.APP_OPS_SERVICE);
                    if (aom.checkOpNoThrow(android.app.AppOpsManager.OPSTR_GET_USAGE_STATS, info.uid, info.packageName) != android.app.AppOpsManager.MODE_ALLOWED) {
