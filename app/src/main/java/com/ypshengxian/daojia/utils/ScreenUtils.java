...
public class ScreenUtils {
    ...
    public static float getScreenScaledDensity() {
        return Utils.getContext().getResources().getDisplayMetrics().scaledDensity;
    }
    ...
    /**
     * 获取当前屏幕截图根据ScrollView
     *
     * @param scrollView 滚动条
     * @return Bitmap
     */
    public static Bitmap captureWithScrollView(ScrollView scrollView) {
        ...
        for (int i = 0; i < scrollView.getChildCount(); i++) {
            ...
            scrollView.getChildAt(i).setBackgroundColor(ResUtils.getColor(R.color.color_white));
        }
        // 创建对应大小的bitmap
