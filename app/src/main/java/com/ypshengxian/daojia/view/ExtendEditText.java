 ...
 * @note -
 */
public class ExtendEditText extends android.support.v7.widget.AppCompatEditText implements View.OnFocusChangeListener, TextWatcher {
    /** 隐藏清除按钮常量 */
    ...
    private void setBounds() {
        if (mTag == TAG_CLEAR) {
            if (mDrawableClear != null) {
                mDrawableClear.setBounds(0, 0, mDrawableClear.getMinimumWidth(), mDrawableClear.getMinimumHeight());
            }
