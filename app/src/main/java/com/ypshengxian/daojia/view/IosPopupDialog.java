...
public class IosPopupDialog extends PopupDialog {
     ...
     * @return this
     */
    public IosPopupDialog setTitle(String title, @ColorRes int color, float textSize) {
        mIsShowTitle = true;
     ...
     * @return this
     */
    public IosPopupDialog setMessage(String msg, @ColorRes int color, float textSize) {
        mIsShowMessage = true;
