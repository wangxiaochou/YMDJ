...
import com.ypshengxian.daojia.utils.EmptyUtils;
...
public class LoadingDialog {
    ...
    public void show(Activity activity, Option option) {
        ...
        if (sDialog == null) {
            ...
            sDialog = new PopupDialog(activity, R.layout.loading_dialog_yp, false);
        ...
        ImageView imageView=(ImageView) sDialog.findViewById(R.id.iv_loading_dialog_img);
        LoaderFactory.getLoader().loadResource(imageView,R.drawable.gif_loading);

        TextView msgText = (TextView) sDialog.findViewById(R.id.tv_loading_dialog_msg_yp);
