...
import com.ypshengxian.daojia.utils.SizeUtils;
...
public class BadgeRadioButton extends DrawableCenterRadioButton {
    ...
    private void showShadowImpl(boolean showShadow, Paint badgeBackgroundPaint) {
        ...
        badgeBackgroundPaint.setShadowLayer(showShadow ? SizeUtils.dp2px(2f) : 0, x, y, 0x33000000);
    }
    ...
    void init() {
        ...
        mBadgeTextSize = ResUtils.getDimensionPixelSize(R.dimen.font_tiny);
        mBadgePadding = SizeUtils.dp2px(4);
